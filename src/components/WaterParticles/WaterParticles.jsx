/**
 * ⚠️ КРИТИЧЕСКИ ВАЖНО: КОМПОНЕНТ WATERPARTICLES - НЕ ТРОГАТЬ! ⚠️
 * 
 * Этот компонент создает 3D анимацию частиц на главной странице.
 * 
 * КРИТИЧЕСКИЕ ПАРАМЕТРЫ:
 * - z-index: 0 (должен быть ниже контента, который имеет z-index: 2)
 * - particleCount: 150 (оптимальное количество для производительности)
 * - Анимация через requestAnimationFrame для плавности
 * 
 * НЕ МЕНЯТЬ:
 * - Логику анимации (может сломать эффект)
 * - z-index в CSS (должен быть 0)
 * - Количество частиц без проверки производительности
 * - Структуру useEffect и cleanup
 * 
 * Можно безопасно изменять только:
 * - Скорость анимации (time += 0.006)
 * - Количество частиц (если тестировали производительность)
