/**
 * ⚠️ КРИТИЧЕСКИ ВАЖНО: ПОДВАЛ (FOOTER) - НЕ ТРОГАТЬ! ⚠️
 * 
 * Этот компонент подвала содержит критически важную структуру:
 * - Фон должен быть идентичным главной странице (#05080d)
 * - Разметка и стили связаны с MainLayout.css
 * 
 * ЗАПРЕЩЕНО ИЗМЕНЯТЬ:
